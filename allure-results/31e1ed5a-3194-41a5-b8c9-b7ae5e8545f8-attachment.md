...
```
Error: locator.click: Error: strict mode violation: locator('a:has-text("PRACTICE")') resolved to 2 elements:
    1) <a href="https://practicetestautomation.com/practice/">Practice</a> aka getByRole('link', { name: 'Practice', exact: true })
    2) <a href="https://practicetestautomation.com/">Practice Test Automation.</a> aka getByRole('link', { name: 'Practice Test Automation.' })

Call log:
  - waiting for locator('a:has-text("PRACTICE")')
...
```ts
  ...
  19 |         this.page = page;
  20 |         this.practiceBtn = page.locator('a:has-text("PRACTICE")')
